...
const RundownMobile = () => {
  return (
    <div className="mx-auto max-w-2xl flex flex-col lg:flex-row py-6 lg:hidden">
      <div className="basis-1/2 py-12 px-8 lg:-my-40 space-y-12 lg:space-y-0">
        <div className={`duration-500`}>
          <div className="relative mb-12 w-80 h-80 bg-carbon-white border border-carbon-bronze/20 shadow-xl shadow-carbon-bronze/40 rounded-2xl">
            <Install />
          </div>
        ...
        <div className={`mx-auto duration-500}`}>
          <div className="w-80 h-80 relative mb-12 bg-carbon-white border border-carbon-bronze/20 shadow-xl shadow-carbon-bronze/40 rounded-2xl">
            <Shop />
          </div>
          <div className="">
            <h1 className="text-2xl lg:text-5xl font-display">
        ...
        <div
          className={`lg:h-screen relative duration-500 ${'lg:text-carbon-bronze/50'}`}
        >
          <div className="w-80 h-80 mb-12 bg-carbon-white border border-carbon-bronze/20 shadow-xl shadow-carbon-bronze/40 rounded-2xl">
            <MiniReceipt />
          </div>
          <div className="">
            <h1 className="text-2xl lg:text-5xl font-display">
...
const RundownDesktop = () => {
  ...
  return (
    <div className="mx-auto max-w-6xl hidden lg:flex flex-col lg:flex-row py-6">
      <div
        ref={ref}
      ...
      <div className="basis-1/2 order-first lg:order-last py-8 lg:py-12 px-8 lg:-my-40">
        <div className="h-full lg:h-screen m-auto sticky top-0">
          <div className="lg:absolute top-1/2 lg:-translate-y-1/2 hidden lg:block">
            <Tilt
